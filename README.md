...
**This program was forked from the original by Xipiter https://github.com/Xipiter/shikra-programmer: The code here has been updated to fix the 'Resource busy' error - no need to rmmod the ftdi_sio kernel module now!**
